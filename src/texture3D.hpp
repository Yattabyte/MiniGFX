...
class Texture3D {
    ...
    inline Texture3D(Texture3D&&) noexcept = delete;
    /** Disallow asset copy constructor. */
    inline Texture3D(const Texture3D&) noexcept = delete;

    // Private Deleted Operators
    /** Disallow asset move assignment. */
    inline Texture3D& operator=(Texture3D&&) noexcept = delete;
    /** Disallow asset copy assignment. */
    inline Texture3D& operator=(const Texture3D&) noexcept = delete;
